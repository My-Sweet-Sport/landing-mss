...
<nav class="h-16 border-b border-accent bg-background">
  <div class="h-full mx-auto flex max-w-(--breakpoint-xl) items-center justify-between px-4 sm:px-6">
    <Logo />
    ...
    <div class="flex items-center gap-3">
      ...
      <Button class="hidden xs:inline-flex">Get Started</Button>
      <div class="md:hidden">
        <NavigationSheet />
      </div>
    </div>
